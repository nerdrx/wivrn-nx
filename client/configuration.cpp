...
const std::vector<config_field> & configuration::config_fields()
{
	static const std::vector<config_field> fields = {
	        ...
	        scalar("reduced_resolution", &configuration::reduced_resolution),
	        scalar("render_scale", &configuration::render_scale),
	        scalar("sharper_center", &configuration::sharper_center),
	        scalar("foveation_strength", &configuration::foveation_strength),
	        scalar("foveation_adaptive", &configuration::foveation_adaptive),
	        scalar("foveation_foveal_qp", &configuration::foveation_foveal_qp),
	        scalar("fsr", &configuration::fsr),
	        scalar("fsr_sharpness", &configuration::fsr_sharpness),
	        scalar("multipath_usb", &configuration::multipath_usb),
	        scalar("multipath_combine", &configuration::multipath_combine),
	        scalar("smooth_pacing", &configuration::smooth_pacing),
	        scalar("fec", &configuration::fec),
	        scalar("fec_adaptive", &configuration::fec_adaptive),
	        scalar("shard_retransmit", &configuration::shard_retransmit),
	        ...
	        scalar("low_poly", &configuration::low_poly),
	        scalar("low_poly_strength", &configuration::low_poly_strength),
	        scalar("low_poly_levels", &configuration::low_poly_levels),
	        scalar("low_poly_full_kernel", &configuration::low_poly_full_kernel),
