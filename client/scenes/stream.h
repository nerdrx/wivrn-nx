...
private:
	...
	// Previous source ID actually submitted, including backward selections and repeats;
	// used by the render-selection counters.
	std::optional<uint64_t> last_selected_source_frame;
