// nxwarp_base_shadow.h -- the encoder's conforming HEVC decode of its own base layer.
//
...
// adds none.
//
// Brought into the server from hybrid-proto/src/base_shadow.h, where it was
// written and tested (NXWARP-HYBRID.md 12.2: 24 frames, 0 mismatched, 0 out of
// order, against the same access units the device harness fed the Pico). The
// prototype copy stays where it is: it is what the colour guard was proved
// against, and it has a test this build does not carry.

#ifndef WIVRN_NXWARP_BASE_SHADOW_H
#define WIVRN_NXWARP_BASE_SHADOW_H
