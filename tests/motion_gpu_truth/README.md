...
For independently rendered 3D frames, pass three linear RGBA8 paths: `motion_gpu_truth 1 0 0 previous.rgba current.rgba future.rgba`. The second and third paths replace translated current/truth images. Supply equal time intervals for step 1. This bypasses synthetic translation, uses a central crop for scoring, and suppresses the irrelevant translated-pyramid diagnostic. It does not apply runtime pose compensation or encode/decode the inputs.
